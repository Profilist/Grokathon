import type { TileInstance, TileKind } from "../../../supabase/functions/_shared/mahjong/sim/tiles";
import { createTileSet, tileLabel } from "../../../supabase/functions/_shared/mahjong/sim/tiles";
