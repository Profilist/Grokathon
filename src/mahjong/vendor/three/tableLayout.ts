...
import type { Meld, PlayerId } from "../../../../supabase/functions/_shared/mahjong/sim/state";
import { sortTiles, type TileInstance } from "../../../../supabase/functions/_shared/mahjong/sim/tiles";
import {
  physicalWallSlotMap,
  wallStackCount,
...
function layoutPlayerRow(
  ...
  return tiles.map((tile, index) => ({
    ...
    faceUp: owner !== "hand" || !tile.id.startsWith("hidden:"),
    physics: false,
  }));
}
